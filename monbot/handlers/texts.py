...
HELP_ADMIN = (
  ...
  "/invite <role> [max_uses] [ttl_sec] — создать приглашение\n"
...
INVGEN_USAGE = "Использование: /invite <role> [max_uses=1] [ttl_sec]"
...
# Mattermost command text. Keep this separate from Telegram command text.
MM_HELP_VIEWER = (
  "Доступные команды:\n"
...
MM_START_INVITE_REQUIRED = "Требуется приглашение. Используйте /monbot start <otp> из ссылки приглашения."
MM_START_INVITE_OK_FMT = "Добро пожаловать. Ваша роль: {role}. Используйте /monbot help."
MM_START_EXISTING_USER = "Привет, {name}. Ваша роль: {role}. Используйте /monbot help."
MM_INVGEN_USAGE = "Использование: /monbot invite <role> [max_uses=1] [ttl_sec]"
MM_ADDUSER_USAGE = "Использование: /monbot adduser <mattermost_id> [role]"
MM_SETROLE_USAGE = "Использование: /monbot setrole <mattermost_id> <role>"
MM_DELUSER_USAGE = "Использование: /monbot deluser <mattermost_id>"
MM_INVALID_USER_ID = "Некорректный mattermost_id."
MM_SETTZ_CURRENT_FMT = "Ваш часовой пояс: {tz}. Использование: /monbot settz <IANA TZ, e.g., Europe/Moscow>"
MM_REPORT_USAGE = "Использование: /monbot report <list|week|month> [когда]"
